module.exports = function (settings) {
  return {
    ...
    radiolist: function (radiostationlist) {
      return require('./radiolist')(radiostationlist, settings)
    },
    searchradio: function (list) {
      return require('./searchradio')(list, settings)
    },
    remove: function (track) {
      return require('./remove')(track, settings)
    }
  }
}
